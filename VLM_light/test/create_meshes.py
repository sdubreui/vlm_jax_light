...
# gmsh.model.geo.addPoint(c, -b, 0, lc, 2)
# gmsh.model.geo.addPoint(c, 0.0, 0, lc, 3)
# gmsh.model.geo.addPoint(0, 0.0, 0, lc, 4)
...
# gmsh.model.mesh.generate(2)
# # ... and save it to disk
# gmsh.write("meshes/rectangular_wing_20_40_no_sym.msh")

#rectangular wing two surfaces
...
# gmsh.model.mesh.generate(2)
# # ... and save it to disk
# gmsh.write("meshes/rectangular_wing_20_40_2surfaces.msh")

# rectangular wing with Horizontal tail 
gmsh.initialize()
# Next we add a new model named "wing" (if gmsh.model.add() is not called a new
# unnamed model will be created on the fly, if necessary):
gmsh.model.add("rectangular_wing_HT")
...
gmsh.model.geo.addPoint(0, 0, 0, lc, 1)
gmsh.model.geo.addPoint(c, 0, 0, lc, 2)
gmsh.model.geo.addPoint(c, b, 0, lc, 3)
gmsh.model.geo.addPoint(0, b, 0, lc, 4)

gmsh.model.geo.addPoint(6*c, 0, 0, lc, 5)
gmsh.model.geo.addPoint(6*c+0.75*c, 0, 0, lc, 6)
gmsh.model.geo.addPoint(6*c+0.75*c, 0.3*b, 0, lc, 7)
gmsh.model.geo.addPoint(6*c, 0.3*b, 0, lc, 8)
...
le2 = gmsh.model.addPhysicalGroup(1, [8], 4)
gmsh.model.setPhysicalName(1,le2,'leading_edge_2')
te2 = gmsh.model.addPhysicalGroup(1, [6], 5)
gmsh.model.setPhysicalName(1,te2,'trailing_edge_2')
wing2 = gmsh.model.addPhysicalGroup(2, [2], 6)
gmsh.model.setPhysicalName(2,wing2,'surface_2')
...
gmsh.model.mesh.setTransfiniteCurve(1,nx1)
gmsh.model.mesh.setTransfiniteCurve(3,nx1)

gmsh.model.mesh.setTransfiniteCurve(5,nx2)
gmsh.model.mesh.setTransfiniteCurve(7,nx2)

gmsh.model.mesh.setTransfiniteCurve(2,ny1)
gmsh.model.mesh.setTransfiniteCurve(4,ny1)
gmsh.model.mesh.setTransfiniteCurve(6,ny2)
gmsh.model.mesh.setTransfiniteCurve(8,ny2)
...
gmsh.model.mesh.generate(2)
# ... and save it to disk
gmsh.write("meshes/rectangular_wing_20_40_HT.msh")